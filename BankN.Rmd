...
believe may represent and unknown value. To replace these values, we have 
...
## Analysis
With this information we can assign the most popular job, to match
each education level

```{r}
bankn$education[bankn$job == mode(bankn[bankn$education == "tertiary","job"]) 
                & bankn$education == ""] <- "tertiary"
bankn$education[bankn$job == mode(bankn[bankn$education == "secondary","job"]) 
                & bankn$education == ""] <- "secondary"
bankn$education[bankn$job == mode(bankn[bankn$education == "primary","job"]) 
                & bankn$education == ""] <- "primary"
summary(bankn$education)
```
