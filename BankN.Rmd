...
>>>>>>> 2bf9b449e7d5ca8545eee82c7d823fe72187af95
```
...
```
### Therefore 324 persons meet this criteria of "low risk"
```{r}
...
## 
Complex Data analysis was done on BankN's pre-pandemic dataset that allowed for us to examine their customers to see which ones could be propositioned for new financial products. 

This subset of customers were evaluated on a number of metrics popular for credit risk analysis. 
